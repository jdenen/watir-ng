...
module WatirNg
  ...
  #
  NG_DIRECTIVES = %w(ng_jq ng_app ng_href ng_src ng_srcset ng_disabled ng_checked ng_readonly 
  ...
  def self.included cls
    NG_DIRECTIVES.map(&:to_sym).each { |ng| cls.attributes << ng } if cls.respond_to? :attributes
  end
end
